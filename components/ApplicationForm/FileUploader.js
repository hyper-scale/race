    ...
    <div className="flex flex-col">
      ...
      <div className="space-y-4">
        ...
        <div className=" ">
          ...
          <ListGroup
          className="w-full dz-preview dz-preview-multiple list-group-lg"
          flush
          >
              ...
              <Row className="align-items-center">
                <div className=" col ml--3">
                  ...
                  <Button className="flex flex-row float-right font-bold not-italic text-[#767676]" data-dz-remove>
                    <i className="not-italic font-normal" data-dz-remove>delete</i>
                  </Button>
                </div>
              </Row>
            </ListGroupItem>
