...
const Explanation = () => {
  return (
    ...
    >Leader Board </button>
          ...
          <div className="pt-6 font-medium text-m text-center">HyperscaleDAO has a strong community of contributors & advisors</div>
          <div className="pt-4 font-medium text-m text-center">The winning DAO gets funding and joins the HyperscaleDAO</div>
          <div className="pt-6 font-medium text-xs text-center text-gray-400">Receive $200k for 5% by filling out a simple application.</div>
          <div className="flex justify-center">
          <div className="pt-2 font-medium text-xs text-center text-gray-400">You'll receive a decision within 1 week. </div>
          <div className ="ml-1 pt-2 cursor-pointer underline font-medium text-xs text-center text-gray-400 hover:text-gray-600 onClick={#}"> Learn more. </div>
          </div>
    ...
    <a className="font-medium" href="https://twitter.com/HyperscaleFund" target="_blank" rel="noopener noreferrer">Twitter</a>
    <a className="">//</a>
    <a className="ml-6 font-medium" href="https://twitter.com/HyperscaleFund" target="_blank" rel="noopener noreferrer">Discord</a>
    </div>
    </div>
    </>
  );
